...
If time, read the article and leave a comment 📝

If I've added value, circle back and enter your [Email Here](https://tinyletter.com/dexters-analytics){target="_blank"} to be alerted when new bite-size content is released. <br/> 
...
As you can see we've got columns in lowerCamel and also in capitals. To standardize, let's now use the `clean_names()` function to tidy these up.
