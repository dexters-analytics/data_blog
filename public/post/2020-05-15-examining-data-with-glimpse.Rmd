...
[Matt Dancho](https://www.linkedin.com/in/mattdancho/){target="_blank"}, early in his [Data Science Foundations with R Course](http://bit.ly/2Z9SHsd){target="_blank"} course, teaches students the importance of examining data before diving into wrangling and exploring it further.
...
The `glimpse()` function aloud us to quickly examine our data - now let's have fun!
